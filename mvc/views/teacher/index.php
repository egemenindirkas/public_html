            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                <th class="col-sm-2 w50 text-center"><?=$this->lang->line('slno')?></th>
                                <th class="col-sm-2 w50 text-center"><?=$this->lang->line('teacher_photo')?></th>
                                <th class="col-sm-2 text-center"><?=$this->lang->line('teacher_name')?></th>
                                <th class="col-sm-2 text-center"><?=$this->lang->line('teacher_email')?></th>
                                <?php if(permissionChecker('teacher_edit')){ ?>
                                <th class="col-sm-2 w50 text-center"><?=$this->lang->line('teacher_status')?></th>
                                <?php } ?>
                                <?php if(permissionChecker('teacher_edit') || permissionChecker('teacher_delete') || permissionChecker('teacher_view')) { ?>
                                <th class="col-sm-2 w50 text-center"><?=$this->lang->line('action')?></th>
                                <?php } ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(customCompute($teachers)) {$i = 1; foreach($teachers as $teacher) { ?>
                                <tr>
                                    <td class="text-center lh35" data-title="<?=$this->lang->line('slno')?>">
                                        <?php echo $i; ?>
                                    </td>
                                    <td class="text-center lh35" data-title="<?=$this->lang->line('teacher_photo')?>">
                                        <?=profileimage($teacher->photo)?>
                                    </td>
                                    <td class="text-center lh35" data-title="<?=$this->lang->line('teacher_name')?>">
                                        <?php echo $teacher->name; ?>
                                    </td>
                                    <td class="text-center lh35" data-title="<?=$this->lang->line('teacher_email')?>">
                                        <?php echo $teacher->email; ?>
                                    </td>
                                    <?php if(permissionChecker('teacher_edit')){ ?>
                                    <td class="text-center" data-title="<?=$this->lang->line('teacher_status')?>">
                                    ...
                                    <?php } ?>
                                    <?php if(permissionChecker('teacher_edit') || permissionChecker('teacher_delete') || permissionChecker('teacher_view')) { ?>
                                    <td class="text-center lh35" data-title="<?=$this->lang->line('action')?>">
                                        <?php 
