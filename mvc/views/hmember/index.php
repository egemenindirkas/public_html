                            ...
                            <div id="all" class="tab-pane active">
                                <div id="hide-table">
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                <th class="col-sm-1 w50 text-center"><?=$this->lang->line('slno')?></th>
                                                <th class="col-sm-2 w50 text-center"><?=$this->lang->line('hmember_photo')?></th>
                                                <th class="col-sm-2 text-center"><?=$this->lang->line('hmember_name')?></th>
                                                <th class="col-sm-2 text-center"><?=$this->lang->line('hmember_roll')?></th>
                                                <th class="col-sm-2 text-center"><?=$this->lang->line('hmember_email')?></th>
                                                <?php if(permissionChecker('hmember_add') || permissionChecker('hmember_edit') || permissionChecker('hmember_delete') || permissionChecker('hmember_view')) { ?>
                                                    <th class="col-sm-2 w100 text-center"><?=$this->lang->line('action')?></th>
                                                <?php } ?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php if(customCompute($students)) {$i = 1; foreach($students as $student) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center lh35" data-title="<?=$this->lang->line('hmember_photo')?>">
                                                        <?=profileimage($student->photo)?>
                                                    </td>
                                                    <td class="text-center lh35" data-title="<?=$this->lang->line('hmember_name')?>">
                                                        <?php echo $student->srname; ?>
                                                    </td>

                                                    <td class="text-center lh35" data-title="<?=$this->lang->line('hmember_roll')?>">
                                                        <?php echo $student->srroll; ?>
                                                    </td>

                                                    <td class="text-center lh35" data-title="<?=$this->lang->line('hmember_email')?>">
